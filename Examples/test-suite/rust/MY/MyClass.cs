...
public class MyClass : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          testPINVOKE.delete_MY_MyClass(swigCPtr);
        }
  ...
  public int value {
    set {
      testPINVOKE.MY_MyClass_value_set(swigCPtr, value);
    } 
    get {
      int ret = testPINVOKE.MY_MyClass_value_get(swigCPtr);
      return ret;
    } 
  }

  public MyClass() : this(testPINVOKE.new_MY_MyClass(), true) {
  }

  public int method() {
    int ret = testPINVOKE.MY_MyClass_method(swigCPtr);
    return ret;
  }
