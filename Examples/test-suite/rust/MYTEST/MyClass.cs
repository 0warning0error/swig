...
public class MyClass : global::System.IDisposable {
  ...
  protected virtual void Dispose(bool disposing) {
    lock(this) {
      if (swigCPtr.Handle != global::System.IntPtr.Zero) {
        if (swigCMemOwn) {
          swigCMemOwn = false;
          testPINVOKE.delete_MYTEST_MyClass(swigCPtr);
        }
  ...
  public int value {
    set {
      testPINVOKE.MYTEST_MyClass_value_set(swigCPtr, value);
    } 
    get {
      int ret = testPINVOKE.MYTEST_MyClass_value_get(swigCPtr);
      return ret;
    } 
  }

  public MyClass() : this(testPINVOKE.new_MYTEST_MyClass(), true) {
  }

  public int method() {
    int ret = testPINVOKE.MYTEST_MyClass_method(swigCPtr);
    return ret;
  }
