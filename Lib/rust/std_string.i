...
%typemap(rsout) const std::string & "SwigString { ptr: $result as *mut std::ffi::c_void }"
...
%typemap(ctype) std::string & "void *"
%typemap(rusttype) std::string & "&mut SwigString"
%typemap(rsffitype) std::string & "*mut std::ffi::c_void"
...
%typemap(rsout) std::string * "$result"
...
%typemap(rsout) const std::string * "$result"
